# Désactivez CUDA pour PyTorch

#initialize
import pandas as pd
import numpy as np

df=pd.read_csv('dataset/sentiment_train.csv')
...
bert = AutoModel.from_pretrained('bert_uncased_L-6_H-768_A-12')
...
for epoch in range(epochs):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model, 'saved_weights.h5')
